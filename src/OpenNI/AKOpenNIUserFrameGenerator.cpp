...
void AKOpenNIUserFrameGenerator::addBoneElements(AKOpenNIUser &openNIUser, XnUserID userID)
{
	...
	setBoneProperties(openNIUser.openNISkeletonBones[AK_OPENNI_BONE_INDEX_RIGHT_LOWER_ARM], openNIUser.openNISkeletonJoints[AK_OPENNI_JOINT_INDEX_RIGHT_ELBOW], 90.0, AK_OPENNI_JOINT_INDEX_RIGHT_ELBOW, AK_OPENNI_JOINT_INDEX_RIGHT_HAND, AK_OPENNI_BONE_INDEX_RIGHT_UPPER_ARM);
